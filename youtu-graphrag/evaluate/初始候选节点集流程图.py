...
# --- 1. 输入层 ---
draw_box(0.5, 3.0, 1.5, 1.0, "用户查询\n(Query)", '#fff9c4', '#fbc02d')

# --- 2. 并行处理层 ---
# 分支点
draw_arrow(2.0, 3.5, 2.5, 3.5)
# 向上：向量路径
draw_arrow(2.5, 3.5, 3.0, 5.0)
draw_box(3.0, 4.5, 2.0, 1.0, "语义编码\n(BGE-M3)", '#e3f2fd', '#1e88e5')
draw_arrow(5.0, 5.0, 5.5, 5.0)
draw_box(5.5, 4.5, 2.5, 1.0, "FAISS向量检索\n(Top-N 扩展)", '#e3f2fd', '#1e88e5')

# 向下：关键词路径
draw_arrow(2.5, 3.5, 3.0, 2.0)
draw_box(3.0, 1.5, 2.0, 1.0, "关键词提取\n(Keyword Ext.)", '#e1bee7', '#8e24aa')
draw_arrow(5.0, 2.0, 5.5, 2.0)
draw_box(5.5, 1.5, 2.5, 1.0, "关键词匹配\n(Keyword Match)", '#e1bee7', '#8e24aa')

# --- 3. 合并层 ---
draw_arrow(8.0, 5.0, 8.5, 3.8) # 上汇入
draw_arrow(8.0, 2.0, 8.5, 3.2) # 下汇入

draw_box(8.5, 2.8, 2.0, 1.4, "候选集合并\n&\n相似度批计算", '#c8e6c9', '#43a047')

# --- 4. 输出层 ---
draw_arrow(10.5, 3.5, 11.0, 3.5)
draw_box(11.0, 2.5, 0.8, 2.0, "初始\n候选\n集", '#ffccbc', '#d84315')
